...
from one_policy_to_run_them_all.environments.unitree_go2.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.unitree_go2.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.unitree_go2.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.unitree_go2.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.unitree_go2.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.unitree_go2.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.unitree_go2.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.unitree_go2.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.unitree_go2.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.unitree_go2.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.unitree_go2.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.unitree_go2.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.unitree_go2.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.unitree_go2.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.unitree_go2.terrain_functions.handler import get_terrain_function


class UnitreeGo2(gym.Env):
    LONG_NAME = "unitree_go2"
    SHORT_NAME = "go2"
    ...
    def get_observation(self):
        ...
        observation[self.foot_time_since_last_ground_contact_update_obs_idx] = np.array([self.reward_function.time_since_last_touchdown_fl, self.reward_function.time_since_last_touchdown_fr, self.reward_function.time_since_last_touchdown_rl, self.reward_function.time_since_last_touchdown_rr])
