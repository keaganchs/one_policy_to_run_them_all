...
from one_policy_to_run_them_all.environments.barkour_v0.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.barkour_v0.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.barkour_v0.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.barkour_v0.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.barkour_v0.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.barkour_v0.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.barkour_v0.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.barkour_v0.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.barkour_v0.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.barkour_v0.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.barkour_v0.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.barkour_v0.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.barkour_v0.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.barkour_v0.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.barkour_v0.terrain_functions.handler import get_terrain_function


class BarkourV0(gym.Env):
    LONG_NAME = "barkour_v0"
    SHORT_NAME = "bkv0"
    ...
    def __init__(self, seed, render,
        ...
        self.initial_drop_height = 0.267
        ...
        collision_groups = [("floor", ["floor"]),
                            ...
                            ("FR_calf", ["FR_calf"]), ("FL_calf", ["FL_calf"]), ("RR_calf", ["RR_calf"]), ("RL_calf", ["RL_calf"]),
                            ("FR_thigh_3", ["FR_thigh_3"]), ("FL_thigh_3", ["FL_thigh_3"]), ("RR_thigh_3", ["RR_thigh_3"]), ("RL_thigh_3", ["RL_thigh_3"]),
    ...
    def get_observation(self):
        ...
        observation[self.foot_time_since_last_ground_contact_update_obs_idx] = np.array([self.reward_function.time_since_last_touchdown_fr, self.reward_function.time_since_last_touchdown_fl, self.reward_function.time_since_last_touchdown_rr, self.reward_function.time_since_last_touchdown_rl])
