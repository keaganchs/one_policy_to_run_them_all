...
from one_policy_to_run_them_all.environments.barkour_vb.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.barkour_vb.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.barkour_vb.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.barkour_vb.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.barkour_vb.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.barkour_vb.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.barkour_vb.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.barkour_vb.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.barkour_vb.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.barkour_vb.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.barkour_vb.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.barkour_vb.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.barkour_vb.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.barkour_vb.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.barkour_vb.terrain_functions.handler import get_terrain_function


class BarkourVB(gym.Env):
    LONG_NAME = "barkour_vb"
    SHORT_NAME = "bkvb"
    ...
    def __init__(self, seed, render,
        ...
        self.max_joint_velocities = np.array([20.0] * 12)
        self.initial_drop_height = 0.34
        ...
        collision_groups = [("floor", ["floor"]),
                            ...
                            ("FL_foot", ["FL_foot"]), ("RL_foot", ["RL_foot"]), ("FR_foot", ["FR_foot"]), ("RR_foot", ["RR_foot"]),
                            ("FL_calf", ["FL_calf"]), ("RL_calf", ["RL_calf"]), ("FR_calf", ["FR_calf"]), ("RR_calf", ["RR_calf"]),
                            ("FL_thigh", ["FL_thigh"]), ("RL_thigh", ["RL_thigh"]), ("FR_thigh", ["FR_thigh"]), ("RR_thigh", ["RR_thigh"]),
        ...
        self.foot_names = ["FL_foot", "RL_foot", "FR_foot", "RR_foot"]
        self.joint_names = [
    ...
    def get_initial_observation(self, multi_robot_max_observation_size):
        ...
        for foot_name in self.foot_names:
            ...
            if foot_name == "FL_foot":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_fl)
            elif foot_name == "RL_foot":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_rl)
            elif foot_name == "FR_foot":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_fr)
            elif foot_name == "RR_foot":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_rr)
    ...
    def get_observation(self):
        ...
        observation[self.foot_time_since_last_ground_contact_update_obs_idx] = np.array([self.reward_function.time_since_last_touchdown_fl, self.reward_function.time_since_last_touchdown_rl, self.reward_function.time_since_last_touchdown_fr, self.reward_function.time_since_last_touchdown_rr])
