...
from one_policy_to_run_them_all.environments.unitree_h1.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.unitree_h1.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.unitree_h1.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.unitree_h1.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.unitree_h1.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.unitree_h1.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.unitree_h1.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.unitree_h1.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.unitree_h1.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.unitree_h1.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.unitree_h1.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.unitree_h1.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.unitree_h1.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.unitree_h1.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.unitree_h1.terrain_functions.handler import get_terrain_function


class UnitreeH1(gym.Env):
    LONG_NAME = "unitree_h1"
    SHORT_NAME = "h1"
    ...
    def __init__(self, seed, render,
        ...
        self.initial_drop_height = 0.985
        ...
        collision_groups = [("floor", ["floor"]),
                            ("left_foot", ["left_foot_1", "left_foot_2", "left_foot_3"]),
                            ("right_foot", ["right_foot_1", "right_foot_2", "right_foot_3"])]
