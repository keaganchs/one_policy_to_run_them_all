...
from one_policy_to_run_them_all.environments.anymal_b.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.anymal_b.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.anymal_b.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.anymal_b.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.anymal_b.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.anymal_b.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.anymal_b.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.anymal_b.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.anymal_b.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.anymal_b.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.anymal_b.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.anymal_b.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.anymal_b.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.anymal_b.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.anymal_b.terrain_functions.handler import get_terrain_function


class AnymalB(gym.Env):
    LONG_NAME = "anymal_b"
    SHORT_NAME = "anyb"
    ...
    def __init__(self, seed, render,
        ...
        self.max_joint_velocities = np.array([15.0] * 12)
        self.initial_drop_height = 0.5
        ...
        if self.add_goal_arrow:
            ...
            trunk.add("body", name="dir_arrow", pos="0 0 0.3")
        ...
        collision_groups = [("floor", ["floor"]),
                            ...
                            ("LF_foot", ["LF_foot"]), ("RF_foot", ["RF_foot"]), ("LH_foot", ["LH_foot"]), ("RH_foot", ["RH_foot"]),
                            ("LF_kfe_act", ["LF_kfe_act"]), ("RF_kfe_act", ["RF_kfe_act"]), ("LH_kfe_act", ["LH_kfe_act"]), ("RH_kfe_act", ["RH_kfe_act"]),
                            ("LF_calf", ["LF_calf"]), ("RF_calf", ["RF_calf"]), ("LH_calf", ["LH_calf"]), ("RH_calf", ["RH_calf"]),
                            ("trunk", ["trunk_1", "trunk_2", "trunk_3", "trunk_4"]),
        ...
        self.foot_names = ["LF_foot", "RF_foot", "LH_foot", "RH_foot"]
        self.joint_names = [
    ...
    def get_initial_observation(self, multi_robot_max_observation_size):
        ...
        for foot_name in self.foot_names:
            ...
            elif foot_name == "LH_foot":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_lh)
            elif foot_name == "RH_foot":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_rh)
    ...
    def get_observation(self):
        ...
        observation[self.foot_time_since_last_ground_contact_update_obs_idx] = np.array([self.reward_function.time_since_last_touchdown_lf, self.reward_function.time_since_last_touchdown_rf, self.reward_function.time_since_last_touchdown_lh, self.reward_function.time_since_last_touchdown_rh])
