...
from one_policy_to_run_them_all.environments.hexapod.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.hexapod.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.hexapod.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.hexapod.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.hexapod.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.hexapod.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.hexapod.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.hexapod.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.hexapod.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.hexapod.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.hexapod.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.hexapod.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.hexapod.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.hexapod.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.hexapod.terrain_functions.handler import get_terrain_function
...
class Hexapod(gym.Env):
    ...
    def __init__(self, seed, render,
        ...
        self.max_joint_velocities = np.array([1.7453292519943295] * 18)
        self.initial_drop_height = 0.161
        ...
        collision_groups = [("floor", ["floor"]),
                            ("feet", ["foot_0", "foot_1", "foot_2", "foot_3", "foot_4", "foot_5"]),
                            ("foot_0", ["foot_0"]), ("foot_1", ["foot_1"]), ("foot_2", ["foot_2"]), ("foot_3", ["foot_3"]), ("foot_4", ["foot_4"]), ("foot_5", ["foot_5"]),
                            ("hip", ["hip_0", "hip_1", "hip_2", "hip_3", "hip_4", "hip_5"]),
                            ("hip_0", ["hip_0"]), ("hip_1", ["hip_1"]), ("hip_2", ["hip_2"]), ("hip_3", ["hip_3"]), ("hip_4", ["hip_4"]), ("hip_5", ["hip_5"]),
                            ("knee_0", ["knee_0"]), ("knee_1", ["knee_1"]), ("knee_2", ["knee_2"]), ("knee_3", ["knee_3"]), ("knee_4", ["knee_4"]), ("knee_5", ["knee_5"]),
                            ("trunk", ["trunk_1", "trunk_2", "trunk_3", "trunk_4", "trunk_5", "trunk_6", "trunk_7"]),
                            ("trunk_1", ["trunk_1"]), ("trunk_2", ["trunk_2"]), ("trunk_3", ["trunk_3"]), ("trunk_4", ["trunk_4"]),
                            ("trunk_5", ["trunk_5"]), ("trunk_6", ["trunk_6"]), ("trunk_7", ["trunk_7"]),]
        ...
        self.joint_names = [
            "leg_0_joint_0", "leg_0_joint_1", "leg_0_joint_2",
            "leg_1_joint_0", "leg_1_joint_1", "leg_1_joint_2",
            "leg_2_joint_0", "leg_2_joint_1", "leg_2_joint_2",
            "leg_3_joint_0", "leg_3_joint_1", "leg_3_joint_2",
            "leg_4_joint_0", "leg_4_joint_1", "leg_4_joint_2",
            "leg_5_joint_0", "leg_5_joint_1", "leg_5_joint_2",
        ]
    ...
    def get_initial_observation(self, multi_robot_max_observation_size):
        ...
        for foot_name in self.foot_names:
            ...
            if foot_name == "foot_0":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_f0)
            elif foot_name == "foot_1":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_f1)
            elif foot_name == "foot_2":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_f2)
            elif foot_name == "foot_3":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_f3)
            elif foot_name == "foot_4":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_f4)
            elif foot_name == "foot_5":
                dynamic_foot_observations.append(self.reward_function.time_since_last_touchdown_f5)
    ...
    def get_observation(self):
        ...
        observation[self.foot_time_since_last_ground_contact_update_obs_idx] = np.array([
            self.reward_function.time_since_last_touchdown_f0, self.reward_function.time_since_last_touchdown_f1, self.reward_function.time_since_last_touchdown_f2,
            self.reward_function.time_since_last_touchdown_f3, self.reward_function.time_since_last_touchdown_f4, self.reward_function.time_since_last_touchdown_f5,
        ])
