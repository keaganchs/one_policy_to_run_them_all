...
from one_policy_to_run_them_all.environments.cassie.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.cassie.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.cassie.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.cassie.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.cassie.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.cassie.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.cassie.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.cassie.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.cassie.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.cassie.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.cassie.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.cassie.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.cassie.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.cassie.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.cassie.terrain_functions.handler import get_terrain_function


class Cassie(gym.Env):
    LONG_NAME = "cassie"
    SHORT_NAME = "cas"
    ...
    def __init__(self, seed, render,
        ...
        self.initial_drop_height = 1.007
        self.complete_nominal_joint_position = np.array([
            0.0, 0.0, self.initial_drop_height, 1.0, 0.0, 0.0, 0.0,
            -0.00449956, 0.0, -0.497301, -0.97861, 0.0164104, -0.0177766, 0.204298, 0.4143, 0.0, -0.4144, 0.0, 1.52439, -1.50645, 1.59681,
            0.00449956, 0.0, 0.497301, 0.97874, 0.0038687, -0.0151572, -0.204509, -0.4143, 0.0, 0.4144, 0.0, -1.52439, 1.50645, -1.59681
        ])
        self.joint_mask_qpos = np.array([7, 8, 9, 14, 20, 21, 22, 23, 28, 34])
        self.joint_mask_qvel = np.array([6, 7, 8, 12, 18, 19, 20, 21, 25, 31])
        self.joint_mask_jnt_vals = np.array([1, 2, 3, 5, 11, 12, 13, 14, 16, 22])
        self.nominal_joint_positions = self.complete_nominal_joint_position[self.joint_mask_qpos]
        self.max_joint_velocities = np.array([
            12.1475, 12.1475, 8.5085, 8.5085, 11.5192,
            12.1475, 12.1475, 8.5085, 8.5085, 11.5192
        ])
        ...
        if self.add_goal_arrow:
            ...
            trunk.add("body", name="dir_arrow", pos="0 0 0.35")
