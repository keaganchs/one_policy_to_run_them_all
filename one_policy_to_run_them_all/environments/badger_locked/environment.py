...
from one_policy_to_run_them_all.environments.badger_locked.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.badger_locked.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.badger_locked.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.badger_locked.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.badger_locked.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.badger_locked.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.badger_locked.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.badger_locked.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.badger_locked.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.badger_locked.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.badger_locked.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.badger_locked.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.badger_locked.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.badger_locked.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.badger_locked.terrain_functions.handler import get_terrain_function


class BadgerLocked(gym.Env):
    LONG_NAME = "badger_locked"
    SHORT_NAME = "bglk"
    ...
    def __init__(self, seed, render,
        ...
        collision_groups = [("floor", ["floor"]),
                            ...
                            ("trunk", ["trunk_1", "trunk_2"]),
                            ("trunk_1", ["trunk_1"]), ("trunk_2", ["trunk_2"])]
