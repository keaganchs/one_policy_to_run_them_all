...
from one_policy_to_run_them_all.environments.sea_snake.viewer import MujocoViewer
from one_policy_to_run_them_all.environments.sea_snake.control_functions.handler import get_control_function
from one_policy_to_run_them_all.environments.sea_snake.command_functions.handler import get_command_function
from one_policy_to_run_them_all.environments.sea_snake.sampling_functions.handler import get_sampling_function
from one_policy_to_run_them_all.environments.sea_snake.initial_state_functions.handler import get_initial_state_function
from one_policy_to_run_them_all.environments.sea_snake.reward_functions.handler import get_reward_function
from one_policy_to_run_them_all.environments.sea_snake.termination_functions.handler import get_termination_function
from one_policy_to_run_them_all.environments.sea_snake.domain_randomization.action_delay_functions.handler import get_get_domain_randomization_action_delay_function
from one_policy_to_run_them_all.environments.sea_snake.domain_randomization.mujoco_model_functions.handler import get_domain_randomization_mujoco_model_function
from one_policy_to_run_them_all.environments.sea_snake.domain_randomization.seen_robot_functions.handler import get_domain_randomization_seen_robot_function
from one_policy_to_run_them_all.environments.sea_snake.domain_randomization.unseen_robot_functions.handler import get_domain_randomization_unseen_robot_function
from one_policy_to_run_them_all.environments.sea_snake.domain_randomization.perturbation_functions.handler import get_domain_randomization_perturbation_function
from one_policy_to_run_them_all.environments.sea_snake.observation_noise_functions.handler import get_observation_noise_function
from one_policy_to_run_them_all.environments.sea_snake.observation_dropout_functions.handler import get_observation_dropout_function
from one_policy_to_run_them_all.environments.sea_snake.terrain_functions.handler import get_terrain_function


class SEASnake(gym.Env):
    LONG_NAME = "sea_snake"
    SHORT_NAME = "snk"
    ...
    def __init__(self, seed, render,
        ...
        self.nominal_joint_positions = np.array([0.0,] * 16)
        self.max_joint_velocities = np.array([2.208932,] * 16)
        self.initial_drop_height = 0.026
        ...
        self.foot_names = ["dummy_foot"]
        self.joint_names = [
            "SA001__MoJo", "SA002__MoJo", "SA003__MoJo", "SA004__MoJo",
            "SA005__MoJo", "SA006__MoJo", "SA007__MoJo", "SA008__MoJo",
            "SA009__MoJo", "SA010__MoJo", "SA011__MoJo", "SA012__MoJo",
            "SA013__MoJo", "SA014__MoJo", "SA015__MoJo", "SA016__MoJo",
        ]
    ...
    def get_initial_observation(self, multi_robot_max_observation_size):
        ...
        for foot_name in self.foot_names:
            ...
            dynamic_foot_observations.extend(self.missing_value * np.ones(self.single_dynamic_foot_observation_length - self.dynamic_foot_description_size, dtype=np.float32))
